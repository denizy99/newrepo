package proje1_yesilMarket;
	...
	public class YesilMarket {
		...
		public static void main(String[] args) {
			...
			sepeteYazdir();
			System.out.println("Ürün eklemek için e girin:");
			devam = scan.next();
		...
		public static void sepeteEkle(int ürünNo, double kg) {
			...
			public static double sepeteYazdir() {
				...
				System.out.println("Ürünler \tKG  \t tFiyatlar");
				System.out.println("===\t   ======== \t========");
				...
				for(int i=0; i<sepetÜrünler.size() ; i++) {
					...
					ftoplam+= sepetFiyatlar.get(i) ;
				
					
				}
				System.out.println("===\t   ======== \t========");
				System.out.println("Toplam  "  + "\t" +  kgtoplam + "\t \t" + ftoplam );
				return ftoplam;
